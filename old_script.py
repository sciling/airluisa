...
def detect_video(yolo, video_path, output_path=""):
    ...
    while (vid.isOpened()):
        try:
            if counter == target: 
                ...
                n_frame = n_frame + 1
                #total_frames.append("frame_"+str(n_frame))
                ...
                # print("CUENTA: ", num_car, num_bike, num_bus, num_truck)
            ...
            df["id_frame"] = total_frames
            df["time_per_frame"] = total_time_frames
            df['cars_per_frame'] = cars_frame
            df['bikes_per_frame'] = bikes_frame
            df['bus_per_frame'] = bus_frame
            df['truck_per_frame'] = truck_frame
            print(df)
            print("otro")
            print(df_info_frame)
            df_info_frame.to_csv("info_frame_PARK.csv", index=False)
            df.to_csv("DataPerFrame_PARK.csv", index = False)
            break
    sum = 0
    ...
    print("Total cars: ", num_car/total_vehicles)
    print("Total bike: ", num_bike/total_vehicles)
    print("Total bus: ", num_bus/total_vehicles)
    print("Total truck: ", num_truck/total_vehicles)

    # with open('porcentaje_vehiculos_tmp8.txt', 'w') as f:
    #     f.write('TOTAL VEHICULOS: '+ str(total_vehicles)+ '\n')
    #     f.write('Por tipo: \n')
    #     f.write('Total Coches ' + str(num_car/total_vehicles) + '\n')
    #     f.write('Total Motos ' + str(num_bike/total_vehicles) + '\n')
    #     f.write('Total Bus ' + str(num_bus/total_vehicles) + '\n')
    #     f.write('Total Truck ' + str(num_truck/total_vehicles) + '\n')
