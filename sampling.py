...
def sampling_video(video_path, output_path, num_frames):
    ...
    while vid.isOpened():
        ...
        if (
            i % num_frames == 0
        ):  # this is the line I added to make it only save one frame every 20
...
if __name__ == "__main__":
    ...
    # video_path = "/home/tgonzalez/Desktop/projects/airLUISA/data/CameraTrafficCorregido.mp4"
    # output_path = "/home/tgonzalez/Desktop/projects/airLUISA/detect_and_track/out/edit_frames/pruebaFrames.avi"
    # num_frames = 5
